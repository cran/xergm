...
%\VignetteKeyword{ERGM}
%\VignetteKeyword{TERGM}
%\VignetteKeyword{sna}
...
\title{Estimating Temporal Exponential Random Graph Models by Bootstrapped Pseudolikelihood\\ \bigskip \Large \texttt{R} package vignette for \pkg{xergm} 1.4}
...
\affil[$\dag$]{The Ohio State University}
...
\begin{figure}[t!]
  \begin{center}
    \includegraphics[width=0.68\textwidth]{btergm-nw}
  \end{center}
...
\begin{figure}[!t]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{btergm-boxplots1}
  \end{center}
...
\begin{figure}[!t]
  \begin{center}
    \includegraphics[width=0.7\textwidth]{btergm-coefs}
  \end{center}
...
\begin{figure}[!t]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{btergm-boxplots2}
  \end{center}
...
\begin{figure}[!t]
  \begin{center}
    \includegraphics[width=0.6\textwidth]{btergm-rocpr}
  \end{center}
